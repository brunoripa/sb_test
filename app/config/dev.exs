...
config :app, AppWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "AC8RV/h8ox5X/D3+pUfVPjMx4JcX7mVi+mq6BAaVKlGtTLfY2sLodNWV8LAGNLCh",
  watchers: [
...
config :app, dev_routes: true, token_signing_secret: "keURbWawnkPRkrz/Xxsxlb1mJWgi9jSf"
